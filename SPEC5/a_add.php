...
<html lang="en">
  ...
  <body>
    <div class="col-lg-8 mx-auto p-3 py-md-5">
      <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
        <span class="fs-4">App -</span> <span class="fs-4">- add new appoinment</span>
      </header>
      <main>
  ...
  <div class="form-group">
    ...
    <input>add<input type="button" value="add" id="add" />
    
    <ul id= 'list'></ul>
    <script type="text/javascript">
      // make button add text and beside it a button to remove it and save it in a list
      
      var button = document.getElementById("add");
      
      button.addEventListener("keypress", function(){
          var li = document.createElement("li");
          var input = document.getElementById("task_1");
  ...
  <script>
    //TO DO --- LOOP FOR EACH APPOINMENT
